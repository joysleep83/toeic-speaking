  ...
  2: [
    {
      ...
      model_answer: "On a typical weekday, I wake up around 6 AM. The first thing I do — out of habit, honestly — is check my phone right after I open my eyes. I know it's not the healthiest habit, but it's become second nature at this point.\n\nI don't usually eat breakfast in the morning. I just get ready and head out of the house by around 6:20. I drive to work, and the commute takes about an hour. During the drive, I usually listen to a podcast or the news on the radio to catch up on what's happening before the day starts.\n\nMy work hours are from 8 to 5, so I'm at the office for most of the day. By the time I get home in the evening, I try to relax a bit before getting to bed at a reasonable hour so I can do it all again the next day.",
  ...
  3: [
    {
      ...
      model_answer: "I currently live in an apartment in Anyang, which is located just south of Seoul. I share the place with my wife, which is nice because we've always been close.\n\nThe apartment itself is a bit old, but it's been renovated, so the interior actually feels quite new. My favorite space is the living room since I really enjoy the view outside the window.\n\nAs for the neighborhood, I absolutely love it. Anyang is moderately lively — there are plenty of restaurants, cafes, and cute little shops nearby. The downside is that the city feels a little outdated in some areas. But honestly, the convenience and character of the area more than make up for that.",
  ...
  4: [
    {
      ...
      model_answer: "I have a few things I like to do in my free time. Out of all of them, the one I'm most passionate about is going to the gym. I started about three years ago, mainly for health reasons, and now I genuinely love it. I try to work out at least three times a week — usually after work.\n\nBesides the gym, I really enjoy cooking. I love trying out new recipes, especially Western dishes. It's quite a creative process, and I find it very satisfying to make a good meal from scratch. I often spend Sunday afternoons happily experimenting in the kitchen.\n\nI also read a lot — mostly books about AI. I'm especially into ones about AI coding. It's become a nice habit before bed, and I always feel like I'm learning something new.",
      explanation: "• 취미 세 가지를 자연스럽게 나열하면서 각각 이유와 맥락 제공\n• \"mainly for health reasons\" — 시작 동기를 자연스럽게 설명\n• \"from scratch\" — 요리 관련 자연스러운 관용 표현\n• \"quite happily\" — 부사 배치로 자연스러운 어조 형성\n• 마지막 취미(AI 관련 독서)로 전문성과 지적인 면모를 보여주며 균형 잡힌 마무리"
    },
    {
