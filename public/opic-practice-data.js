  ...
  1: [
    {
      ...
      model_answer: "Sure! My name is Jiyeon, and I'm currently working as a marketing coordinator at a mid-sized company in Seoul. I've been in this role for about two years, and I really enjoy the creative aspects of the job. I live in a small but cozy apartment in Mapo-gu with my roommate. The neighborhood is great because it's close to cafes and parks.\n\nIn terms of my personality, I'd say I'm pretty outgoing and always curious about new things. Outside of work, I spend a lot of time reading, going to the gym, and occasionally trying out new restaurants. I'm also really into traveling — I try to take at least one trip a year. Overall, I think I lead a pretty balanced and fulfilling life, and I'm always looking for ways to grow both personally and professionally.",
      explanation: "• 이름·직업·거주지를 자연스럽게 소개하며 구체적인 정보 포함\n• \"I've been in this role for about two years\" — 현재완료로 경험 기간 자연스럽게 표현\n• \"In terms of my personality\" — 주제 전환 표현으로 답변 구조화\n• 취미를 쉼표로 나열하고 마지막만 and로 연결하는 자연스러운 어순\n• 마무리 문장으로 전체적인 삶의 방향 제시해 완성도 부여"
    },
    {
  ...
  2: [
    {
      ...
      model_answer: "On a typical weekday, I usually wake up around 7 AM. The first thing I do is check my phone for messages — not the best habit, I know, but it helps me wake up. Then I take a shower, have a quick breakfast — usually toast and coffee — and head out by 8:30.\n\nI commute to work by subway, which takes about 40 minutes. During the ride, I usually listen to podcasts or read on my phone. Work runs from 9 to 6, and depending on the day, I might have meetings in the morning or focus on individual tasks in the afternoon.\n\nAfter work, I try to go to the gym two or three times a week. On other evenings, I cook at home or watch something on Netflix. I usually try to be in bed by 11:30 to get at least seven hours of sleep. It's not glamorous, but it works for me.",
      explanation: "• 시간 순서대로 하루를 서술 (wake up → commute → work → evening)\n• \"not the best habit, I know\" — 자기 인식을 보여주는 자연스러운 삽입 어구\n• \"depending on the day\" — 유연한 일상을 표현하는 현실적인 표현\n• 구체적인 시간(7 AM, 8:30, 9 to 6, 11:30) 사용으로 생동감 있는 묘사\n• \"It's not glamorous, but it works for me\" — 개성 있는 마무리"
    },
    {
